TestCase("BrickTest", {
    ...
    "test : brick should have coordinates when just created":function () {
        // When
        var brick = new Brick(this.gameArea, 1, 2);
    ...
    "test : brick should return left bound coordinate x":function () {
        ...
        // Then
        assertEquals(1 * (Brick.WIDTH + Wall.SPACE_BETWEEN_BRICKS), leftBoundCoordinateX);
    },
    "test : bar should return right bound coordinate x":function () {
        ...
        // Then
        assertEquals(1 * (Brick.WIDTH + Wall.SPACE_BETWEEN_BRICKS) + Brick.WIDTH, rightBoundCoordinateX);
    },
    "test : bar should return top bound coordinate y":function () {
        ...
        // Then
        assertEquals(2 * (Brick.HEIGHT + Wall.SPACE_BETWEEN_BRICKS), topBoundCoordinateY);
    },
    "test : bar should return bottom bound coordinate y":function () {
        ...
        // Then
        assertEquals(2 * (Brick.HEIGHT + Wall.SPACE_BETWEEN_BRICKS) + Brick.HEIGHT, bottomBoundCoordinateY);
    },
