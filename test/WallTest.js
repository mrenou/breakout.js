RequireJSTestCase("WallTest", ["Brick", "Wall", "GameArea"],
    {
        "setUp":function () {
            JsHamcrest.Integration.JsTestDriver();
            JsMockito.Integration.JsTestDriver();
            this.gameArea = new this.r.GameArea(1000, 1000, TestUtils.getContextMocked());
        },
        "test : wall should be initiated with bricks":function () {
            // When
            var wall = new this.r.Wall(this.gameArea);
            ...
            assertInstanceOf(this.r.Brick, wall.bricks[1][2]);
        },/*
