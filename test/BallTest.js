TestCase("BallTest", {
    ...
    "test : ball should return left bound coordinate x":function () {
        ...
        // Then
        assertEquals(this.COORDINATE_X - Ball.RADIUS, leftBoundCoordinateX);
    },
    "test : ball should return right bound coordinate x":function () {
        ...
        // Then
        assertEquals(this.COORDINATE_X + Ball.RADIUS, rightBoundCoordinateX);
    },
    "test : ball should return top bound coordinate y":function () {
        ...
        // Then
        assertEquals(this.COORDINATE_Y - Ball.RADIUS, topBoundCoordinateY);
    },
    "test : ball should return bottom bound coordinate y":function () {
        ...
        // Then
        assertEquals(this.COORDINATE_Y + Ball.RADIUS, bottomBoundCoordinateY);
    },
    "test : ball should move diagonal up right":function () {
        ...
        // Then
        assertEquals(this.COORDINATE_X + Ball.SPEED, ball.coordinates.x);
        assertEquals(this.COORDINATE_Y - Ball.SPEED, ball.coordinates.y);
    },
    ...
    "test : ball should init":function () {
        ...
        assertEquals(ball.gameArea.bar.coordinates.y - Ball.RADIUS, ball.coordinates.y);
    },
    getBall:function () {
        var gameArea = new GameArea(1000, 1000, {});
    ...
    mockCollision:function (ball, collisions) {
        ball.ballCollisionMotor = mock(BallCollisionMotor);
